...
const StatCard = ({ Icon, label, sublabel, value, badge, accentText, accentBg }) => (
    <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm dark:shadow-none border border-slate-100 dark:border-slate-800 hover:shadow-md transition-all duration-300">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm">{sublabel}</p>
    </div>
);
        ...
        return (
            <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center p-4 transition-colors duration-300">
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm dark:shadow-none border border-slate-100 dark:border-slate-800 p-12 text-center max-w-md">
                    ...
                    <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">Cargando Dashboard</h2>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Obteniendo estadísticas del sistema...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 transition-colors duration-300">
            <div className="max-w-7xl mx-auto">
                ...
                <header className="mb-8">
                    <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-full px-4 py-1.5 mb-4 shadow-sm dark:shadow-none">
            ...
            {data.map((item) => (
                <div key={item.name} className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-slate-600 dark:text-slate-400">
                        {item.name}: <span className="font-semibold text-slate-800 dark:text-slate-200">{item.value}</span>
                    </span>
                </div>
            ))}
        </div>
