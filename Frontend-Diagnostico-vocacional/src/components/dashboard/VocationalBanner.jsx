...
const VocationalBanner = ({ userName, topArea }) => {
    ...
    return (
      <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h2 className="text-2xl font-bold text-slate-800 mb-2">Hola, {name} 👋</h2>
          <p className="text-slate-600 max-w-2xl leading-relaxed mb-5">
  ...
  const { Icon, text, bg } = getVocationalIcon(topArea);
  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden">
      ...
      <div className="relative z-10">
        <h2 className="text-2xl font-bold text-slate-800 mb-4">Hola, {name} 👋</h2>

        <div className="flex items-start gap-4">
          <div className={`${bg} ${text} p-3.5 rounded-2xl flex-shrink-0`}>
          ...
          <div>
            ...
            <p className="text-xl font-bold text-slate-900 leading-tight mb-1.5">{topArea}</p>
